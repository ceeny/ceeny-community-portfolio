      ...
      <section id="top" className="relative isolate min-h-[760px] border-b border-white/10 pt-32 sm:pt-40">
        ...
        <div className="mx-auto grid max-w-[1320px] gap-16 px-5 pb-24 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end lg:gap-12 lg:px-12 lg:pb-32">
          ...
          <div className="relative mx-auto w-full max-w-[480px] lg:mb-4">
            <div className="relative aspect-square overflow-hidden rounded-[2rem] border border-white/12 bg-white/[0.035] p-6 shadow-[0_30px_100px_rgba(0,0,0,0.35)] sm:p-9">
              <div className="absolute inset-5 rounded-[1.5rem] border border-white/10" /><div className="absolute inset-12 rounded-full border border-cyan/20 [transform:rotate(30deg)]" /><div className="absolute inset-[22%] rounded-full border border-lilac/30 [transform:rotate(-25deg)]" /><div className="absolute left-1/2 top-1/2 h-28 w-28 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan/10 blur-2xl" />
              <div className="absolute left-1/2 top-1/2 grid h-24 w-24 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border border-cyan/70 bg-ink text-cyan shadow-[0_0_55px_rgba(91,239,255,0.18)]"><Crosshair size={36} strokeWidth={1.3} /></div>
              <span className="absolute left-9 top-9 rounded-full bg-acid px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.18em] text-ink">01 / 01</span><span className="absolute bottom-9 right-9 max-w-[145px] text-right text-[10px] font-bold uppercase leading-5 tracking-[0.16em] text-white/45">Make every message move the mission forward.</span><div className="absolute right-10 top-[31%] h-2 w-2 rounded-full bg-acid shadow-[0_0_20px_rgba(230,255,114,0.85)]" /><div className="absolute bottom-[28%] left-12 h-1.5 w-1.5 rounded-full bg-lilac shadow-[0_0_18px_rgba(156,140,255,0.9)]" />
            </div>
