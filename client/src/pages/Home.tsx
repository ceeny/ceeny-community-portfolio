...
const timeline = [
  {
    ...
    label: "Ethereum Layer 2 · community-led",
    logo: "https://raw.githubusercontent.com/ceeny/ceeny-community-portfolio/main/media/metis-logo.png",
    about:
      "Metis is an Ethereum Layer 2 built around the idea of an instant, accessible, and increasingly community-led network. Its current direction pairs scalable infrastructure with AI-aligned products and Community Ecosystem Governance.",
    description:
      "I was the human layer between the ecosystem and its members — keeping a live Telegram room clear, welcoming, and useful while helping people understand updates, access, and participation.",
    bullets: [
      "Moderated conversations and protected the signal-to-noise ratio.",
      "Answered questions about updates, access, and ecosystem participation.",
  ...
  },
  {
    ...
    company: "LazAI",
    role: "Community Manager",
    label: "Decentralized AI · data ownership",
    logo: "https://raw.githubusercontent.com/ceeny/ceeny-community-portfolio/main/media/lazai-logo.jpg",
    about:
      "LazAI is a Web3-native AI infrastructure protocol building a decentralized foundation for personalized AI. Its ecosystem connects AI agents, user-owned data, asset protocols, and tools such as DAT, iDAO, and verifiable computing.",
    description:
      "I helped make a technically ambitious AI ecosystem easier to enter and easier to stay engaged with — translating the project story into useful community support and steady day-to-day operations.",
    bullets: [
      ...
      "Supported a large Telegram community with consistent communication.",
    ],
  },
];
...
export default function Home() {
  return (
    <main className="overflow-hidden bg-ink text-white">
      ...
      <section id="top" className="relative isolate min-h-[760px] border-b border-white/10 pt-32 sm:pt-40">
        ...
        <div className="mx-auto grid max-w-[1320px] gap-16 px-5 pb-24 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end lg:gap-12 lg:px-12 lg:pb-32">
          <div className="max-w-3xl">
            <div className="mb-8 flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.22em] text-cyan"><span className="h-2 w-2 animate-pulse rounded-full bg-cyan shadow-[0_0_18px_rgba(91,239,255,0.9)]" />Available for remote roles</div>
      ...
      <section id="work" className="border-y border-white/10 bg-[#0c0d1a]"><div className="mx-auto max-w-[1320px] px-5 py-24 sm:px-8 lg:px-12 lg:py-32"><div className="mb-16 flex flex-col justify-between gap-6 sm:flex-row sm:items-end"><div><p className="section-kicker">Selected experience</p><h2 className="mt-5 max-w-xl font-display text-5xl font-bold leading-[0.95] tracking-[-0.055em] sm:text-7xl">Built close to the community.</h2></div><p className="max-w-xs text-sm leading-6 text-white/42 sm:text-right">Two ecosystems. One consistent operating principle: make it easier for good people to participate.</p></div><div className="space-y-5">{timeline.map((item, index) => <article key={item.company} className="group grid gap-8 rounded-[1.6rem] border border-white/10 bg-white/[0.035] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-cyan/35 hover:bg-white/[0.055] sm:p-8 lg:grid-cols-[0.22fr_0.34fr_0.44fr] lg:gap-12 lg:p-10"><div className="flex justify-between lg:block"><div><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-cyan">0{index + 1}</p><p className="mt-5 text-[10px] font-bold uppercase tracking-[0.16em] text-white/38">{item.year}</p></div><span className="grid h-10 w-10 place-items-center rounded-full border border-white/10 text-white/38 transition-colors group-hover:border-cyan/35 group-hover:text-cyan lg:mt-12"><ArrowUpRight size={16} /></span></div><div><div className="mb-5 flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/90 p-2"><img src={item.logo} alt={`${item.company} logo`} className="h-full w-full object-contain" /></div><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/38">{item.label}</p><h3 className="mt-3 font-display text-4xl font-bold tracking-[-0.05em] text-white sm:text-5xl">{item.company}</h3><p className="mt-2 text-sm font-semibold text-lilac">{item.role}</p></div><div><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-cyan">About the project</p><p className="mt-3 max-w-xl text-sm leading-7 text-white/55">{item.about}</p><p className="mt-5 text-[10px] font-bold uppercase tracking-[0.18em] text-white/38">My role</p><p className="mt-3 max-w-xl text-sm leading-7 text-white/72">{item.description}</p><ul className="mt-6 space-y-3">{item.bullets.map((bullet) => <li key={bullet} className="flex gap-3 text-xs leading-5 text-white/45"><Check size={15} className="mt-0.5 shrink-0 text-cyan" />{bullet}</li>)}</ul></div></article>)}</div></div></section>

      <section className="mx-auto max-w-[1320px] px-5 py-24 sm:px-8 lg:px-12 lg:py-32"><div className="mb-14 flex items-end justify-between gap-8"><div><p className="section-kicker">Proof of work</p><h2 className="mt-5 max-w-2xl font-display text-5xl font-bold leading-[0.95] tracking-[-0.055em] sm:text-7xl">Access is earned.</h2></div><Radio className="hidden text-cyan sm:block" size={34} strokeWidth={1.2} /></div><div className="grid gap-6 lg:grid-cols-2"><article className="overflow-hidden rounded-[1.6rem] border border-white/10 bg-white/[0.035] shadow-[0_30px_90px_rgba(0,0,0,0.28)]"><div className="relative overflow-hidden bg-black/40 p-3"><div className="overflow-hidden rounded-[1.1rem] bg-[#15161e]"><img src="https://raw.githubusercontent.com/ceeny/ceeny-community-portfolio/main/media/metis-community-proof.jpeg" alt="Metis Telegram community showing moderator access and live member count" className="block h-[360px] w-full object-cover object-top" loading="lazy" /></div><div className="absolute left-7 top-7 rounded-full bg-acid px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.16em] text-ink">Live community evidence</div></div><div className="p-7 sm:p-8"><div className="flex items-center gap-3"><img src="https://raw.githubusercontent.com/ceeny/ceeny-community-portfolio/main/media/metis-logo.png" alt="Metis logo" className="h-9 w-9 rounded-lg bg-black object-contain p-1" /><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-cyan">Metis · Telegram</p></div><h3 className="mt-4 max-w-lg font-display text-3xl font-bold leading-[0.98] tracking-[-0.05em] sm:text-4xl">Trusted with the room, not just the replies.</h3><p className="mt-5 text-sm leading-7 text-white/55">Moderator access in a live Metis community, helping members navigate updates, access, and ecosystem participation with less friction.</p><div className="mt-7 grid grid-cols-2 gap-3"><div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4"><Gauge className="mb-6 text-cyan" size={18} /><p className="font-display text-2xl font-bold">15.6K</p><p className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/38">Visible members</p></div><div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4"><Layers3 className="mb-6 text-lilac" size={18} /><p className="font-display text-2xl font-bold">MOD</p><p className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/38">Role in the room</p></div></div><a href="https://t.me/MetisL2" target="_blank" rel="noreferrer" className="group mt-7 inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-cyan">View community <ArrowUpRight size={15} className="transition-transform duration-200 group-hover:translate-x-1 group-hover:-translate-y-1" /></a></div></article><article className="overflow-hidden rounded-[1.6rem] border border-blue-400/20 bg-gradient-to-br from-[#0f1d3a] to-white/[0.035] shadow-[0_30px_90px_rgba(0,0,0,0.28)]"><div className="relative overflow-hidden bg-[#edf5ff] p-3"><div className="overflow-hidden rounded-[1.1rem] bg-[#dfeeff]"><img src="https://raw.githubusercontent.com/ceeny/ceeny-community-portfolio/main/media/lazai-community-proof.png" alt="LazAI Global Telegram community showing moderator access and live member count" className="block h-[360px] w-full object-cover object-top" loading="lazy" /></div><div className="absolute left-7 top-7 rounded-full bg-[#1e66ff] px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.16em] text-white">New evidence</div></div><div className="p-7 sm:p-8"><div className="flex items-center gap-3"><img src="https://raw.githubusercontent.com/ceeny/ceeny-community-portfolio/main/media/lazai-logo.jpg" alt="LazAI logo" className="h-9 w-9 rounded-lg bg-[#eaf5ff] object-contain" /><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#6fa8ff]">LazAI · Telegram</p></div><h3 className="mt-4 max-w-lg font-display text-3xl font-bold leading-[0.98] tracking-[-0.05em] sm:text-4xl">Making a technical ecosystem feel human.</h3><p className="mt-5 text-sm leading-7 text-white/60">Admin access in the LazAI Global community, supporting a fast-growing AI infrastructure ecosystem where clear onboarding and consistent answers matter.</p><div className="mt-7 grid grid-cols-2 gap-3"><div className="rounded-2xl border border-white/10 bg-white/[0.06] p-4"><Gauge className="mb-6 text-[#6fa8ff]" size={18} /><p className="font-display text-2xl font-bold">62.2K</p><p className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/45">Visible members</p></div><div className="rounded-2xl border border-white/10 bg-white/[0.06] p-4"><Layers3 className="mb-6 text-[#6fa8ff]" size={18} /><p className="font-display text-2xl font-bold">ADMIN</p><p className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/45">Role in the room</p></div></div><a href="https://t.me/lazai_global" target="_blank" rel="noreferrer" className="group mt-7 inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-[#6fa8ff]">View community <ArrowUpRight size={15} className="transition-transform duration-200 group-hover:translate-x-1 group-hover:-translate-y-1" /></a></div></article></div></section>
